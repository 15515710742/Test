...
momObj.prototype.draw = function(){
    ...
    ctx1.drawImage(this.bigEye[this.bigEyeIndex],-this.bigEye[this.bigEyeIndex].width*0.5,-this.bigEye[this.bigEyeIndex].height*0.5);  //绘制大鱼眼睛
    ctx1.drawImage(this.bigBody[0],-this.bigBody[0].width*0.5,-this.bigBody[0].height*0.5);  //绘制大鱼身体
    ctx1.drawImage(this.bigTail[0],-this.bigTail[0].width*0.5+30,-this.bigTail[0].height*0.5);  //绘制大鱼尾巴
    ctx1.restore();                //恢复画笔状态
}
//4.将mom.js添加index.html
//5.在main.js中创建大鱼对象并且调用相应的方法